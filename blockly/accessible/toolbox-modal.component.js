  ...
  template: `
    <div *ngIf="modalIsVisible" class="blocklyModalCurtain"
      ...
      <div id="toolboxModal" class="blocklyModal" role="alertdialog"
        ...
        <p style="font-size: 18px; font-weight: bold;" id="toolboxModalHeading">{{'SELECT_A_BLOCK'|translate}}</p>

        <div *ngFor="#toolboxCategory of toolboxCategories; #categoryIndex=index">
          <p style="font-size: 16px; font-weight: bold;" *ngIf="toolboxCategory.categoryName">{{toolboxCategory.categoryName}}</p>
