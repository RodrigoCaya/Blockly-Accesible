  ...
  showBlockOptionsModal: function(block) {
    ...
    actionButtonsInfo.push({
      action: function() {
        ...
        setTimeout(function() {
          var message = blockDescription + ' eliminado. ' + (
              that.utilsService.isWorkspaceEmpty() ?
              'El espacio de trabajo está vacío.' : 'Estás en el espacio de trabajo.');
      ...
      if (e.keyCode == 13) {
        ...
        while (dfsStack.length) {
          ...
          if (currentNode.tagName == 'BUTTON') {
            ...
            this.notificationsService.speak(
                'Escribe un valor, luego presiona Enter para confirmar.');
            found = true;
            break;
        ...
        if (e.keyCode == 27 || e.keyCode == 37) {
          ...
          if (potentialPrevSibling) {
            ...
            var statusMessage = 'Llegaste al principio de la lista.';
            if (this.getParentLi_(activeDesc)) {
              statusMessage += ' Presiona la flecha izquierda para moverte al padre.';
            }
          ...
          if (potentialNextSibling) {
            ...
            this.audioService.playOopsSound('Llegaste al final de la lista.');
          }
        }
